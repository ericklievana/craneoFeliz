...
\begin{flushright}
  \textbf{#2}
  %\href{#3}{\includegraphics[height=\myMheight]{facebookLogo.png}}
...
{\AddToHook{shipout/background}{\put(0in,-\paperheight){\includegraphics[width=\paperwidth,height=\paperheight]{paper2.png}}}}

\section{Nota Literaria}
\thispagestyle{empty}
Buenas tardes, buenas noches, buenos dias, señoras y señores.
...
\begin{center}
  %\noindent\includegraphics[keepaspectratio,width=15cm]{literatura.png}
\end{center}
